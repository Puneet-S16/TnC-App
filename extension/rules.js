/**
 * rules.js
 * Contains the dictionary of red flag patterns and the analysis logic.
 *
 * NOTE: This is rule-based logic (RegEx). It is NOT AI/ML.
 * It detects keywords and phrases that signal common risks.
 */
...
/**
 * Analyzes the given text for red flags.
 * @param {string} text - The terms text to analyze.
 * @returns {object} - Result object containing detected flags and risk score.
 */
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { analyzeText, RED_FLAGS };
}
